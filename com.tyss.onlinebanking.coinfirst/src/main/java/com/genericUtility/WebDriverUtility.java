...
public class WebDriverUtility {
	...
	/**
	 * this method used for explicit wait
	 * @param driver
	 * @param sec
	 * @return
	 */
	...
	/**
	 * this method used for particular element visible
	 * @param driver
	 * @param sec
	 * @param element
	 */
	...
	/**
	 * this method used for click on particular element
	 * @param driver
	 * @param sec
	 * @param element
	 */
	...
	public void mousehover(WebDriver driver, WebElement element)
	{
		...
		public Robot robotObj() throws AWTException
		{
			...
			public void selectByVisibleText(String string,WebElement element) {
				selectobj(element).selectByVisibleText(string);
			}
			public void selectclassvalue(String value,WebElement element) {
